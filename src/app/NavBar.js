      ...
      <header>
        ...
        <div className="stacking-bars">
          ...
          <ul className="top-bar ">
            ...
            <li>
              <Link className="mobile-show whatsapp-logo" style={{ alignSelf: "center", paddingLeft: "1.5em" }} aria-label="dgs whatsapp link" target="_blank" href="https://wa.me/17785586341">
