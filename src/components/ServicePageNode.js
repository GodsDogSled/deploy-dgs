  ...
  return (
    <section className="service-page-node">
      <div className="image-container">
        <Image width={100} height={200} sizes="50vw" className="pic" style={{ objectFit: "cover", borderRadius: "0px 15px 15px 15px", border: "solid 6px white" }} layout="responsive" src={photo} alt={`image of ${room}`}></Image>
